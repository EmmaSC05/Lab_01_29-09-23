...
Because some of the n_2021 values are NA so calculating the mean and median based on this is not possible as some values are strings and not numbers.
...
It suggests that most of the data is lower, however there are some very large outliers in the data which would allow the median to remain low but would mean that the mean is significantly higher than the median.
